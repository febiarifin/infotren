                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        ...
                        <div class="single-package-item">
                            <div class="single-package-item-txt">
                                <div class="packages-para">
                                    <iframe src="{!! $pesantren->maps_url !!}" class="my-maps-box" style="border:0;"
                                ...
                                <div class="packages-para">
                                    <div class="row">
                                        ...
                                        @foreach ($pesantren->galeris as $galeri)
                                            <div class="col-md-3">
                                                <img src="{{ asset($galeri->image) }}" alt="package-place"
                                                    class="my-image-box" />
                                            </div>
                                        @endforeach
                            ...
                            <div class="single-package-item-txt">
                                ...
                                <div class="packages-para">
                                    ...
                                    <p>
                                        ...
                                        <b><a href="https://instagram.com/{{ $pesantren->instagram }}"
                                                target="_blank">{{ $pesantren->instagram }}</a></b>
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        <b><a href="https://facebook.com/{{ $pesantren->facebook }}"
                                                target="_blank">{{ $pesantren->facebook }}</a></b>
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        <b><a href="https://youtube.com/{{ $pesantren->youtube }}"
                                                target="_blank">{{ $pesantren->youtube }}</a></b>
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        <b><a href="{{ $pesantren->website }}"
                                                target="_blank">{{ $pesantren->website }}</a></b>
                                    </p>
                                </div>
    ...
    <script>
        ...
        */
        (function() { // DON'T EDIT BELOW THIS LINE
            ...
            s.src = 'https://infotren.disqus.com/embed.js';
