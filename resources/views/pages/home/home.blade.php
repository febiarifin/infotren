					...
					<div class="col-sm-12">
						<div class="single-about-us">
							<div class="about-us-txt">
								<h2><span style="color: #5dad7c; text-shadow:0px 0.5px 0.5px #fff">INFOTREN</span> <br><span style="color:#fff;font-size: 35pt">Sistem Informasi Pondok Pesantren</span></h2>
								<div class="about-btn">
