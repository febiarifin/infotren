                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 @error('alamat') has-error @enderror">
                                    ...
                                    <input type="text" class="form-control" id="inputError" value="{{ old('alamat') }}"
                                ...
                                <div class="form-group col-md-6 @error('maps_url') has-error @enderror">
                                    ...
                                    <input type="link" class="form-control" id="inputError" value="{{ old('maps_url') }}"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="inputError"
                                        placeholder="Channel Youtube" name="youtube">
                                </div>
                            ...
                            <div class="form-group bg-gray rounded mt-2 p-1">
                                ...
                                <textarea class="textarea form-control" rows="20" placeholder="Place some text here" name="content" required>{{ old('content') }}</textarea>
                            </div>
